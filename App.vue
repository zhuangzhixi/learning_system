<script>
export default {
	//这里的数据可以全局使用，不用每个页面都引入，直接使用app.globalData.变量名即可
	globalData: {
		onReview: false,
		small_shelves: '1.0.0',
		openid: '',
		...
		site_h5url: "http://139.199.229.136:3007/",
		// site_h5url: "http://localhost:3007/",
		// site_h5url: "https://334c414.r7.vip.cpolar.cn/",
		...
		// #endif
		// #ifndef MP-WEIXIN
		socket_url: "https://demo.sdwanyue.com:19967",
		// #endif
